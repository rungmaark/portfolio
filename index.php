    ...
    <body>
        ...
        <section class="about-section" id="about">
            <div class="container">
                ...
                <div class="about-me">
                    <h1>About Me</h1>
                    <p>ผมชื่อมาร์ค อายุ 17 ปี ปัจจุบันผมมีความสามารถในการสร้าง Website และ Game เหตุผลที่ผมต้องการเรียนคณะนี้เพราะ ผมต้องการเข้าใจเทคโนโลยีอย่างลึกซึ้ง<br>เพื่อต่อยอดงานที่ผมกำลังพัฒนาอยู่ให้มีมาตรฐานมากขึ้น<br>ผมเชื่อว่าผมมีศักยภาพมากพอที่จะพัฒนา Technology ของคนไทยให้มีผลกระทบในระดับโลกได้ครับ และการได้เข้าเรียนคณะวิทยาการคอมพิวเตอร์ก็เป็นส่วนนึงที่จะทำให้ความฝันของผมเป็นจริงครับ</p>
                </div>
            </div>
        </section>
        <!-- education section -->
